...
const ProductItemCard = ({
  ...
  return (
    <Link href={`/product/${id}`}>
      <a className="transform hover:transition duration-200 hover:scale-105 hover:no-underline shadow-md rounded-md">
        <div className="bg-white  rounded-md min-w-full h-75 lg:h-80  md:h-80">
          ...
          <div className="ml-2 pt-2 pb-3 md:pt-6 lg:pt-6">
            ...
            <p className="truncate text-base text-gray-600 text-md">
              {condition}
            </p>
          </div>
        </div>
